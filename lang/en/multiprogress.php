...
$string['multiprogressfieldset'] = 'Multi progress fieldset';
$string['multiprogressname'] = 'Multi progress';
$string['multiprogressname_help'] = 'Multi progress';
$string['multiprogresssettings'] = 'Multi progress settings';
...
$string['nomultiprogressinstances'] = 'Multi progress instances';
$string['nonewmodules'] = 'No newmodules';
$string['pluginadministration'] = 'newmodule administration';
$string['pluginname'] = 'Multi progress';
$string['privacy:metadata'] = 'Multi progress does not store any personal data';
$string['view'] = 'View';
